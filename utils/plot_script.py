...
smplx_kinematic_chain_no_mask = [[0, 2, 5, 8, 11], [0, 1, 4, 7, 10], [0, 3, 6, 9, 12, 15], [9, 14, 17, 19, 21], [9, 13, 16, 18, 20],
                            [21, 40, 41, 42],  # Right hand index finger
                            [21, 43, 44, 45],  # Right hand middle finger
                            [21, 46, 47, 48],  # Right hand little finger
                            [21, 49, 50, 51],  # Right hand ring finger
                            [21, 52, 53, 54],  # Right hand thumb
                            [20, 25, 26, 27],  # Left hand index finger
                            [20, 28, 29, 30],  # Left hand middle finger
                            [20, 31, 32, 33],  # Left hand little finger
                            [20, 34, 35, 36],  # Left hand ring finger
                            [20, 37, 38, 39],  # Left hand thumb
                   ]
